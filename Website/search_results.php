    ...
    <div id="stuffcontainer">
        <?php
            ...
            <form action="page_create.php" method="post">
                ...
                <input type="text" name="definition" value="<?php echo $definition ?>" style="visibility:hidden"/>
                <input type="text" name="contributor" value="<?php echo $contributor ?>" style="visibility:hidden"/>
                <br/>
            </form>
        <?php
        }
